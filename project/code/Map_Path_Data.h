...
#define IDENTIFICATION_UP 3     // 识别目标在上方位置标记
#define IDENTIFICATION_DOWN 4   // 识别目标在下方位置标记
#define IDENTIFICATION_LEFT 5   // 识别目标在左方位置标记
#define IDENTIFICATION_RIGHT 6  // 识别目标在右方位置标记
