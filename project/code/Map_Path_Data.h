...
extern const char map_text9[]; // 预设地图文本9（-1-1.txt）
extern const char map_text10[]; // 预设地图文本10（1-2.txt）
extern const char map_text11[]; // 预设地图文本11（-2-1.txt）
extern const char map_text12[]; // 预设地图文本12（2-2.txt）
