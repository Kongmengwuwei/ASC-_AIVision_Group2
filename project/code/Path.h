...
#define PRESTART_MOVE_FORWARD_M   0.36f
#define PRESTART_MOVE_BACKWARD_M  0.00f
#define PRESTART_MOVE_DX_M        (PRESTART_MOVE_FORWARD_M - PRESTART_MOVE_BACKWARD_M)
#define PRESTART_MOVE_DY_M        (PRESTART_MOVE_LEFT_M - PRESTART_MOVE_RIGHT_M)
