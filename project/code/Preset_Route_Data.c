 ...
 *
 * All routes start and end at landing_grid (3,0). They are the fixed
...
static const preset_point_t s_route1_points[] = {
    ...
    ROUTE_POINT(3U, 3U),
    ROUTE_POINT(3U, 4U),
	ROUTE_FAKE(3U, 5U, PRESET_FACE_MAP_RIGHT),//识别第一个箱子
	ROUTE_POINT(2U, 5U),
    ROUTE_POINT(2U, 6U),
    ROUTE_POINT(2U, 7U),
	ROUTE_FAKE(2U, 8U, PRESET_FACE_MAP_DOWN),
    ROUTE_POINT(2U, 7U),
	ROUTE_POINT(2U, 6U),
    ROUTE_POINT(2U, 5U),
	ROUTE_POINT(3U, 5U),
...
static const preset_point_t s_route2_points[] = {
    ROUTE_POINT(3U, 0U),
    ROUTE_FAKE(3U, 1U, PRESET_FACE_MAP_UP),//识别第一个箱子
    ROUTE_POINT(4U, 1U),
    ROUTE_POINT(5U, 1U),
    ROUTE_POINT(5U, 2U),
    ROUTE_POINT(5U, 3U),
    ROUTE_POINT(5U, 4U),
    ROUTE_FAKE(5U, 5U, PRESET_FACE_MAP_RIGHT),//识别第二个箱子
	ROUTE_POINT(6U, 5U),
    ROUTE_POINT(6U, 6U),
    ROUTE_POINT(6U, 7U),
    ROUTE_POINT(6U, 8U),
    ROUTE_POINT(6U, 9U),
    ROUTE_FAKE(5U, 9U, PRESET_FACE_MAP_UP),//第一个目标
    ROUTE_FAKE(4U, 9U, PRESET_FACE_KEEP),//第二个目标
	ROUTE_POINT(3U, 9U),
	ROUTE_POINT(2U, 9U),
	ROUTE_POINT(2U, 10U),
	ROUTE_POINT(2U, 11U),
...
static const preset_point_t s_route3_points[] = {
	ROUTE_FAKE(3U, 0U, PRESET_FACE_KEEP),//识别第一个目标
    ROUTE_POINT(4U, 0U),
    ROUTE_POINT(5U, 0U),
    ROUTE_POINT(6U, 0U),
    ROUTE_FAKE(7U, 0U,PRESET_FACE_KEEP),//在推炸弹的路上识别第一个箱子
    ROUTE_POINT(7U, 1U),
    ROUTE_POINT(6U, 1U),
    ROUTE_STOP(5U, 1U),//推完第一个炸弹
    ROUTE_FAKE(5U, 2U,PRESET_FACE_MAP_DOWN),//在路上识别第二个箱子
    ROUTE_POINT(5U, 3U),
    ROUTE_POINT(5U, 4U),
    ROUTE_POINT(5U, 5U),
    ROUTE_POINT(6U, 5U),
    ...
    ROUTE_POINT(6U, 8U),
    ROUTE_POINT(6U, 9U),
    ROUTE_STOP(6U, 10U),//推完第二个炸弹
    ROUTE_POINT(6U, 11U),
    ROUTE_STOP(7U, 11U),//推完第三个炸弹
    ROUTE_POINT(8U, 11U),
	ROUTE_POINT(9U, 11U),
    ROUTE_POINT(9U, 10U),
	ROUTE_POINT(9U, 9U),
	ROUTE_POINT(9U, 8U),
	ROUTE_POINT(9U, 7U),
	ROUTE_FAKE(9U, 6U,PRESET_FACE_MAP_LEFT),//识别完第二个目标
	ROUTE_POINT(9U, 7U),
    ROUTE_POINT(9U, 8U),
	ROUTE_POINT(9U, 9U),
	ROUTE_POINT(9U, 10U),
