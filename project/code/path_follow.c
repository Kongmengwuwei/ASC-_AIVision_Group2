...
#define PATH_FOLLOW_TARGET_X_FROM_Y_RUN_COMP_K 0.026f
...
#define PATH_YAW_FEEDFORWARD_MIN_DEGPS 2.0f
...
#define PATH_ROTATE_SLOWDOWN_BAND_DEG 0.0f //在n度以下开始减速 
#define PATH_ROTATE_SLOWDOWN_MIN_DEGPS 0.0f //在n度以下减速到最小角速度
...
#define PATH_FOLLOW_YAW_TOLERANCE_DEG 0.7f
...
#define PATH_TARGET_SETTLE_TIME_MS 50U
...
#define PATH_FOLLOW_PID_STAY_KP 1.3f
...
/** @brief 航向￿PID 比例系数￿*/
#define PATH_FOLLOW_PID_YAW_KP 1.1f
/** @brief 航向￿PID 积分系数￿*/
#define PATH_FOLLOW_PID_YAW_KI 0.0f
/** @brief 航向￿PID 微分系数￿*/
#define PATH_FOLLOW_PID_YAW_KD 2.8f
/** @brief 航向￿D 项滤波系数�?*/
