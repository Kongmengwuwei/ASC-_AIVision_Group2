...
#define PF_ARRIVAL_MAX_SPEED_CMPS        3.0f
#define PF_ARRIVAL_DECEL_CMPS2           105.0f
...
#define PF_Y_CROSSTALK_LEFT_X_COMP_K      0.009f
#define PF_Y_CROSSTALK_RIGHT_X_COMP_K    -0.007f
