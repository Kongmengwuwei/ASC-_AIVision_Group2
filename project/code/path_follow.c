...
#define PF_LINE_GUIDE_KP                 2.0f    /* 双向高速实测可降低峰值横偏且避免过纠。 */
...
{
    {0.30f,   0.40f, 1.70f, 8.00f},
    {0.50f,   0.50f, 1.70f, 8.00f},
    {0.70f,   0.65f, 1.70f, 8.00f},
    {0.90f,   0.75f, 1.70f, 8.00f},
    {1000.0f, 1.50f, 1.70f, 8.00f}
};
