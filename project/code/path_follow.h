...
void path_follow_set_position_pid(float kp, float ki, float kd, float max_output_cmps, float alpha);
...
extern float path_line_guide_max_cmps;
extern float path_line_guide_deadband_m;
extern float path_yaw_feedforward_min_degps;
extern float path_yaw_feedforward_deadband_deg;
extern float path_yaw_hold_feedforward_min_degps;
extern float path_yaw_hold_max_degps;
